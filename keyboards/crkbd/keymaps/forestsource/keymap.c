...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      TRNS,   NO,    NO,    NO,   PAST,  PLUS,                   MINS,  EQL,   LCBR,  RCBR,  PIPE,  TRNS,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
  ...
  [_FUNCTION] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
      RST,    NO,    NO,   MVOM,  MVOD,  MVOU,                    NO,   BRMD,  BRMU,   NO,    NO,    NO,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      LTOG,   NO,    MS_L, MS_D,  MS_U,  MS_R,                   LEFT,  DOWN,   UP,   RGHT,   NO,   TRNS,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       NO,    UNDO,  CUT,  COPY,  PSTE,   NO,                    BTN1,  BTN2,   NO,    NO,    NO,    NO,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  TRNS,  TRNS,  SPC,       ENT,  TRNS,  TRNS\
                              //`--------------------'  `-----------------------'
  )
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case NUMBER:
      if (record->event.pressed) {
        layer_on(_NUMBER);
        update_tri_layer_RGB(_NUMBER, _SYMBOL, _FUNCTION);
      } else {
        layer_off(_NUMBER);
        update_tri_layer_RGB(_NUMBER, _SYMBOL, _FUNCTION);
      }
